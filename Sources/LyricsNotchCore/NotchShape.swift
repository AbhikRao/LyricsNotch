...
public struct NotchShape: Shape {
    ...
    public init(
        ...
        self.topCornerRadius = topCornerRadius ?? NotchMetrics.closedCornerRadii.top
        self.bottomCornerRadius = bottomCornerRadius ?? NotchMetrics.closedCornerRadii.bottom
    }
